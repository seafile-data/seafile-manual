...
Download [docker-compose.yml](https://manual.seafile.com/docker/pro-edition/10.0/docker-compose.yml "docker-compose.yml") sample file to your host. Then modify the file according to your environtment. The following fields are needed to be modified:

* The password of MySQL root (MYSQL\_ROOT\_PASSWORD and DB\_ROOT\_PASSWD)
