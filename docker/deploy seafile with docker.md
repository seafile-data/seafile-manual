...
Download [docker-compose.yml](https://manual.seafile.com/docker/docker-compose.yml "docker-compose.yml") sample file to your host. Then modify the file according to your environtment. The following fields are needed to be modified:
